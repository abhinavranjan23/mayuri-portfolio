        ...
        <section className="contact-section" id="contact">
            <div className="contact-wrapper">
                ...
                <div className="social-links-container">
                    <a href="https://www.linkedin.com/in/mayuri-kumari1/" target="_blank" rel="noreferrer" className="social-card" data-cursor-button="true" aria-label="Connect on LinkedIn">
                    ...
                    <a href="https://www.youtube.com/@Mayurisaitav" target="_blank" rel="noreferrer" className="social-card" data-cursor-button="true" aria-label="Subscribe on YouTube">
                    ...
                    <a href="https://www.instagram.com/saitavmayuri/" target="_blank" rel="noreferrer" className="social-card" data-cursor-button="true" aria-label="Follow on Instagram">
